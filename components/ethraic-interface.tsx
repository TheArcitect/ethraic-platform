      ...
      <div className="flex flex-col items-center gap-8 z-10">
        ...
        {!useVoice && (
          <input
            ...
            placeholder={
              mode === 'personal' ? "What are you thinking about?" :
              mode === 'team' ? "What should we explore?" :
              "What needs solving?"
            }
        ...
        {isProcessing && (
          <div className="flex gap-2">
            ...
            <span className="w-2 h-2 bg-white/50 rounded-full animate-pulse" style={{ animationDelay: '0.2s' }} />
            <span className="w-2 h-2 bg-white/50 rounded-full animate-pulse" style={{ animationDelay: '0.4s' }} />
          </div>
        )}
